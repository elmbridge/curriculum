...
Download the Skeleton app here: [https://github.com/elmbridge/elmoji-translator/releases/tag/release-6](https://github.com/elmbridge/elmoji-translator/releases/tag/release-6) and navigate to the downloaded folder. Start `elm reactor` in your terminal:
