...
Download the skeleton app here: [https://github.com/elmbridge/elmoji-translator/releases/tag/release-6](https://github.com/elmbridge/elmoji-translator/releases/tag/release-6), navigate to the downloaded folder in your terminal, and run the following command:
